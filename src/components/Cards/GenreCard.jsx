  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1">
        <img crossOrigin="anonymous" ref={imageRef} onLoad={onLoad}  src={genre.image?.[1]?.link || genre.image?.[0]?.link} alt={genre.name} className="rounded-xl absolute h-[120%] min-h-[60px] aspect-square bottom-[-10px] right-[-10%] rotate-[20deg] shadow-2xl shadow-black/50 bg-black/50 transition-transform group-hover:rotate-[15deg] group-hover:scale-[1.05]" /> {/* Use Saavn image links */}
      </div>
    </Link>
  )
}
